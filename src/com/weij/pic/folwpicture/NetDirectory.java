...
public class NetDirectory extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		StaggeredAdapter adapter = new StaggeredAdapter(NetDirectory.this, R.id.imageView1, urls);
		...
		gview.setOnItemClickListener(new StaggeredGridView.OnItemClickListener() {
			...
			public void onItemClick(StaggeredGridView parent, View view,
				...
				Intent intent = new Intent(NetDirectory.this,
